        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefinementInstruction = table.Column<string>(type: "text", nullable: true),
                    RegeneratedSection = table.Column<string>(type: "text", nullable: true),
                    LtrOutput = table.Column<string>(type: "text", nullable: true),
                    StrOutput = table.Column<string>(type: "text", nullable: true),
                    SocialOutput = table.Column<string>(type: "text", nullable: true),
                    HeadlinesJson = table.Column<string>(type: "text", nullable: true),
                    IsFlaggedForAnalyzer = table.Column<bool>(type: "boolean", nullable: false),
                    UsageUnitsConsumed = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
