        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetPolicy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PlatformsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefinementInstruction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RegeneratedSection = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LtrOutput = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StrOutput = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialOutput = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HeadlinesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsFlaggedForAnalyzer = table.Column<bool>(type: "bit", nullable: false),
                    UsageUnitsConsumed = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Generations_Properties_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Generations_PropertyId",
                table: "Generations",
                column: "PropertyId");
